...
test.describe("Business flow Farm -> Harvest", () => {
  test("@ui @critical should keep full chain consistent across UI and API", async ({
    ...
    const harvest = await harvestController.createHarvest(harvestPayload);
